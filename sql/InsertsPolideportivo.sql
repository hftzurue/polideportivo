...
INSERT INTO usuario(nombre,primer_apellido,segundo_apellido,correo,nombre_usuario,contrasena,rol) VALUES
('Alexander','Salazar','Rojas','alexsr@gmail.com','alexsr','','ADMINISTRADOR'),
('Bryan','Hernandez','Gutierrez','bryanhg@gmail.com','bryanhg','','ADMINISTRADOR'),
('Tzu Rue','Hsu','Fu','tzuruehf@gmail.com','tzuruehf','','ADMINISTRADOR'),
('Jose','Reyes','Lopez','joserl@gmail.com','joserl','','CLIENTE'),
('Maria','Jimenez','Porras','mariajp@gmail.com','mariajp','','CLIENTE'),
('Mario','Rojas','Segura','mariors@gmail.com','mariors','','CLIENTE'),
('Andrey','Jimenez','Nuñez','andreyjn@gmail.com','andreyjn','','CLIENTE'),
('Walter','Flores','Duran','walterfd@gmail.com','walterfd','','CLIENTE'),
('Keylor','Muñoz','Garro','keylormg@gmail.com','keylormg','','CLIENTE'),
('Pablo','Segura','Lopez','pablosl@gmail.com','pablosl','','CLIENTE'),
('Andrea','Porras','Espinoza','andreape@gmail.com','andreape','','CLIENTE'),
('Erika','Gonzalez','Fallas','erikagf@gmail.com','erikagf','','CLIENTE'),
('Martin','Ruiz','Costa','martinrc@gmail.com','martinrc','','CLIENTE'),
('Ignacio','Badilla','Lopez','ignaciobl@gmail.com','ignaciobl','','CLIENTE'),
('Monica','Martinez','Solano','monicams@gmail.com','monicams','','CLIENTE'),
('Sofia','Herrera','Cortez','sofiahc@gmail.com','sofiahc','','CLIENTE'),
('Fabiola','Mendez','Rojas','fabiolamr@gmail.com','fabiolamr','','CLIENTE'),
('Alonso','Quesada','Viquez','alonsoqv@gmail.com','alonsoqv','','CLIENTE'),
('Cristian','Fallas','Segura','cristianfs@gmail.com','cristianfs','','CLIENTE'),
('Rodrigo','Peñas','Cespedez','rodrigopc@gmail.com','rodrigopc','','CLIENTE'),
('Talia','Umaña','Diaz','taliahd@gmail.com','taliahd','','CLIENTE');
